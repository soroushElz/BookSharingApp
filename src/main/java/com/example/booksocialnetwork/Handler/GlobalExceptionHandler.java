package com.example.booksocialnetwork.Handler;
...
import static com.example.booksocialnetwork.Handler.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ChangePasswordTokenException.class)

...
public class AuthenticationController {
    ...
    public ResponseEntity<String> confirm(
        ...
        var activatedAccountToken=authenticationService.activateAccount(token);
        return ResponseEntity.ok("user account "+activatedAccountToken.getUser().getName()+ " activated");
    }
